...
if (isset($_SESSION['registration_success'])) {
    ...
    unset($_SESSION['registration_success']); // Remove after displaying
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['contact_submit'])) {
    ...
    // Set form type as 'index' for submissions from homepage
    $form_type = 'index';
...
if ($services_result && $services_result->num_rows > 0) {
    ...
    $services = [
        ['name' => 'Painters', 'image' => 'images/Painters.png', 'description' => 'Transform your home with a fresh coat of paint! Our professional painters provide smooth, flawless finishes and expert color consultation for every room.'],
        ['name' => 'Electrical', 'image' => 'images/s2.png', 'description' => 'Ensure your home\'s electrical system is safe and efficient with our certified electricians. From lighting installations to wiring upgrades, we handle all your electrical needs.'],
        ['name' => 'Plumbing', 'image' => 'images/s3.png', 'description' => 'Fix leaks, clogged drains, and water heater issues with our expert plumbing services. Our licensed plumbers offer fast, reliable solutions to keep your home running smoothly.']
    ];
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <style>
    ...
    /* Remove the padding-top since we're handling this with JavaScript */
    body {
      padding-top: 0;
    }
    ...
    /* New CSS for side edges and spacing */
    .container {
      padding-right: 30px;
      padding-left: 30px;
      max-width: 1300px;
    ...
    /* Add side margins for full-width sections */
    .hero_area, 
    .feature_section,
    .about_section,
    ...
    /* Improved box shadows for sections */
    .feature_section,
    .about_section,
    .professional_section,
    .service_section {
...
<body>
  ...
  <div class="alert alert-success" style="position: fixed; top: 10px; left: 50%; transform: translateX(-50%); z-index: 1000; padding: 15px 20px; border-radius: 5px;">
          ...
          <div class="col-md-6 ">
            <div class="detail-box">
             <b> <h1>
              ...
              <p>
                Welcome to QuickHire Labor:A Dedicated Website Platform for Customer in Need of Construction and Service Provider , where we bring your services and construction dreams to life. we specialize in delivering high-quality residential, commercial, and industrial construction projects. From planning and design to execution and finishing touches, our team of skilled professionals ensures every detail is handled with care and precision. We’re committed to safety, efficiency, and customer satisfaction, using the latest technology and sustainable practices to create structures that stand the test of time. Trust us to build your future—on time and within budget.
              </p>
  ...
  <section id="aboutUs" class="about_section layout_padding-bottom">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p >
              Connecting People with Skilled Laborers for Quality Service .<br>

              At Quick-Hire Labor, we’re all about making it easier for people to find reliable and experienced laborers for their projects. Whether you need a plumber, electrician, cleaner, or any other skilled professional, our platform provides a fast, easy, and secure way to get the job done.
              
              We act as a trusted interface that brings together those in need of services and the workers who provide them. Our goal is to simplify the hiring process, ensuring that users can quickly find the right laborer for their specific needs, and that laborers have the opportunity to connect with customers who value their skills.            </p>
            <a href="aboutus.php">
              Read More
            </a>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
              we specialize in providing top-quality home services that make life easier and more comfortable. Whether you need expert plumbing, electrical, cleaning, carpentry, or general home maintenance, we’re here to take care of it all. With years of experience and a team of certified, skilled professionals, we deliver reliable, efficient, and affordable solutions to meet the needs of homeowners.            </p>
            <a href="services.php">
              Read More
            </a>
          </div>
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="images/Painters.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Painters
              ...
              <p>
                Transform your home with a fresh coat of paint! Our professional painters provide smooth, flawless finishes and expert color consultation for every room.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Ensure your home’s electrical system is safe and efficient with our certified electricians. From lighting installations to wiring upgrades, we handle all your electrical needs.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Fix leaks, clogged drains, and water heater issues with our expert plumbing services. Our licensed plumbers offer fast, reliable solutions to keep your home running smoothly.
              </p>
            </div>
          </div>
        </div>
  ...
  <!-- </form> -->
  <div id="faq-header" class="faq-header">Frequently Asked Questions</div>

  <div class="faq-content">
    <div class="faq-question">
      <input id="q1" type="checkbox" class="panel">
      <div class="plus">+</div>
      <label for="q1" class="panel-title">What services do you offer?</label>
      <div class="panel-content">We provide construction services such as residential building, commercial projects, renovation, interior design, and project management.</div>
    </div>
    
    <div class="faq-question">
      <input id="q2" type="checkbox" class="panel">
      <div class="plus">+</div>
      <label for="q2" class="panel-title">How can I contact your team?</label>
      <div class="panel-content">You can reach us via email, phone, or by filling out the contact form on our Contact Us page.</div>
    </div>
    
    <div class="faq-question">
      <input id="q3" type="checkbox" class="panel">
      <div class="plus">+</div>
      <label for="q3" class="panel-title">Do you have a cancellation or refund policy?</label>
      <div class="panel-content">Yes, our policies are detailed on the Terms and Conditions page. Please refer to it for more information. </div>
    </div>
    <div class="container">
      <a href="faq.php" class="btn btn-primary"><input type="submit" value="View More"></a>
    </div>
  </div>
